...
class TestSpecialCharsAndPhalas:
    ...
    def test_reph_alternate_key(self):
        # Shift+f is an alternate single-key way to produce রেফ, same
        # output as the two-key r+h sequence.
        assert compose(["F"]) == "র্" == compose(["r", "h"])
